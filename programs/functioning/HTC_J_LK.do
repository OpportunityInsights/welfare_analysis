...
********************************************************************
/* 0. Program: HOPE Tax Credit -- Joint Lower Kink  */
********************************************************************
...
****************************************************
local parental_earnings = 94000 // Table 1 in Bulman and Hoxby (2015)
local usd_year = 2007
...
if "${got_HTC_J_LK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global HTC_J_LK_cost_of_college = r(cost_of_college)
    global HTC_J_LK_net_tuition = r(tuition)
    global got_HTC_J_LK_costs yes
}

local net_tuition = $HTC_J_LK_net_tuition
local cost_of_college = $HTC_J_LK_cost_of_college
