...
/*
local static_tax_fe = 565 // KLT Page 256, Table 8.5.
*Participant short-term tax payment due to program participation.

local static_welfare_fe = -2615 // KLT Page 256, Table 8.5.
*Participant short-term change in welfare receipt due to program participation.

local initial_earnings = 1028 // KLT Page 256, Table 8.5.
...
local alt_program_admin = 123 * `deflate_76' // Kemper, Long, Thornton (1984) Page 256, Table 8.5.  Augmented using the inflation adjustment from Couch 1992, found in footnote 8.
*Cost saving to the government of other training programs foregone when individuals enroll in NSW.

local alt_program_training = 10 * `deflate_76'  // Kemper, Long, Thornton (1984) Page 256, Table 8.5.  Augmented using the inflation adjustment from Couch 1992, found in footnote 8.
*Reductions in payments to individuals from training programs foregone when
*individuals enroll in NSW.

local mean_age = 34 // Couch Table A1: Experimental mean age = 33.16. Control mean age = 33.79.

local age_1985 = 33 + 10 // Couch 1992, pg. 387.

local proj_start_age = `age_1985' + 2
local project_year = 1987
local program_year = 1976

local program_pay = 3815 * `deflate_76' // Kemper, Long, Thornton (1984) Page 256, Table 8.5. Augmented using the inflation adjustment from Couch 1992, found in footnote 8.
*Figure for net cost to "participant."

local program_cost = 5901 * `deflate_76' //Kemper, Long, Thornton (1984) Page 256, Table 8.5.  Augmented using the inflation adjustment from Couch 1992, found in footnote 8.
...
*No direct income observed but policy aimed at AFDC eligible so use federal poverty line
