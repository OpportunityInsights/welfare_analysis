...
**********************************************************************
/* 0. Program: American Opportunity Tax Credit -- Single Phase End  */
**********************************************************************
...
*********************************
/*
local impact_attendance = -0.000002 // Bulman and Hoxby 2015a, Table 14, adjusted to positive value
...
local tax_value = 0.2164388 // Bulman and Hoxby 2015a, Table 13
...
local core_edu_cost = 0.127346 //Bulman and Hoxby 2015a, Table 14, adjusted to positive value. No observable p-value, but permutation test fails at 5% level.
local core_edu_cost_p = runiform(0.05, 0.9) 

local net_tuition_paid = 0.124465 //Bulman and Hoxby 2015a, Table 14, adjusted to positive value. No observable p-value, but permutation test fails at 5% level.
local net_tuition_paid_p = runiform(0.05, 0.9)
...
****************************************************
local parental_earnings = 90000 //Bulman and Hoxby 2015a, Table 1
...
if "${got_AOTC_S_UK_costs}"!="yes" {

	cost_of_college, year(`project_year')  type_of_uni("rmb")
	global cost_of_college_AOTC_S_UK = r(cost_of_college)
	global net_tuition_AOTC_S_UK = r(tuition)
	
	global got_AOTC_S_UK_costs yes
	}
local cost_of_college = $cost_of_college_AOTC_S_UK
local net_tuition = $net_tuition_AOTC_S_UK
