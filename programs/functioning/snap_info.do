...
local effect_take_up_p = runiform(0, 0.001) // effect_take_up_p = "<.001"
local effect_take_up_n_treat = 5314
...
local month_benefit_low = 16 //Assumption explained Finkelstein and Notowidigdo (2018) p. 27
local month_benefit_high = 178 //Assumption explained Finkelstein and Notowidigdo (2018) p. 27
...
local WTP = `benefit_effect_info_low' + `benefit_effect_info_high'
