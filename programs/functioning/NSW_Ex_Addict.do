...
local static_tax_fe = 293 // KLT Page 256, Table 8.5.
*Participant short-term tax payment due to program participation.

local static_welfare_fe = -530 // KLT Page 256, Table 8.5.
*Participant short-term change in welfare receipt due to program participation.

local initial_earnings = -153 // KLT Page 256, Table 8.5.
...
local program_cost = 4413 // Kemper, Long, Thornton (1984) Page 256, Table 8.5.
*Figure for net cost to "non-participant."

local program_pay = 2558 // Kemper, Long, Thornton (1984) Page 256, Table 8.5.
*Figure for net cost to "participant."

local alt_program_admin =  85 // Kemper, Long, Thornton (1984) Page 256, Table 8.5.
*Cost to the government of other training programs foregone when individuals enroll in NSW.
local alt_program_training = 13 // Kemper, Long, Thornton (1984) Page 256, Table 8.5.
...
local change_transfers = -`fe_rate'*`earn_impact_obs'
