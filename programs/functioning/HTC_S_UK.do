**********************************************************************
/* 0. Program: HOPE Tax Credit -- Single Upper Kink  */
**********************************************************************
...
****************************************************
local parental_earnings = 57000 // Table 1 in Bulman and Hoxby (2015)
local usd_year = 2007
...
/*
This section calculates the long-term changes to government costs and individual
earnings that come about as the result of higher college attendance.
*/
...
if "${got_HTC_S_UK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global HTC_S_UK_cost_of_college = r(cost_of_college)
    global HTC_S_UK_net_tuition = r(tuition)
    global got_HTC_S_UK_costs yes
}

local net_tuition = $HTC_S_UK_net_tuition
local cost_of_college = $HTC_S_UK_cost_of_college
