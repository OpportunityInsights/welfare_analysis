...
***********************************************************************
/* 0. Program: HOPE Tax Credit -- Joint Upper Kink  */
***********************************************************************
...
****************************************************
local parental_earnings = 114000 // Table 1 in Bulman and Hoxby (2015)
...
if "${got_HTC_J_UK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global HTC_J_UK_cost_of_college = r(cost_of_college)
    global HTC_J_UK_net_tuition = r(tuition)
    global got_HTC_J_UK_costs yes
}

local net_tuition = $HTC_J_UK_net_tuition
local cost_of_college = $HTC_J_UK_cost_of_college
