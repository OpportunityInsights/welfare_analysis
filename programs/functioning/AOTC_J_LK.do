...
********************************************************************
/* 0. Program: American Opportunity Tax Credit -- Joint Phase Start  */
********************************************************************
...
*********************************
/*
local impact_attendance = 0.000007  // Bulman and Hoxby 2015a, Table 14
...
local tax_value = 0.1074026 // Bulman and Hoxby 2015a, Table 13, adjusted to positive value
...
****************************************************
local parental_earnings = 160000 // Bulman and Hoxby (2015) Table 1
local usd_year = 2011
...
if "${got_AOTC_J_LK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global AOTC_J_LK_cost_of_college = r(cost_of_college)
    global AOTC_J_LK_net_tuition = r(tuition)
    global got_AOTC_J_LK_costs yes
}

local cost_of_college = $AOTC_J_LK_cost_of_college
local net_tuition = $AOTC_J_LK_net_tuition
