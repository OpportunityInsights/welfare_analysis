...
***********************************************************************
/* 0. Program: American Opportunity Tax Credit -- Joint Phase End   */
***********************************************************************
...
/*
Appendix Note: Try by subtracting grant from private tuition costs
*/
...
/*
local impact_attendance = -0.000007  // Bulman and Hoxby 2015a, Table 14, adjusted to positive value
...
local tax_value = 0.1146557 // Bulman and Hoxby 2015a, Table 13
...
****************************************************
local parental_earnings = 180000 // Bulman and Hoxby (2015) Table 1
local usd_year = 2011
...
if "${got_AOTC_J_UK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global AOTC_J_UK_cost_of_college = r(cost_of_college)
    global AOTC_J_UK_net_tuition = r(tuition)
    global got_AOTC_J_UK_costs yes
}

local cost_of_college = $AOTC_J_UK_cost_of_college
local net_tuition = $AOTC_J_UK_net_tuition
...
*/
local uninduced = min(1,1-`impact_attendance')
