...
**********************************************************************
/* 0. Program: American Opportunity Tax Credit -- Independent Single Lower Kink */
**********************************************************************
...
****************************************************
local individual_earnings = 80000 // Bulman and Hoxby (2015) Table 1
local usd_year = 2011
...
local individual_age = 25 //This is a somewhat arbitrary assumption given that most independent filers are over 24 but the papers lists limited impact of AOTC on older individual
...
if "${got_AOTC_I_LK_costs}"!="yes" {
    cost_of_college, year(`project_year')  type_of_uni("rmb")
    global AOTC_I_LK_cost_of_college = r(cost_of_college)
    global AOTC_I_LK_net_tuition = r(tuition)
    global got_AOTC_I_LK_costs yes
}

local cost_of_college = $AOTC_I_LK_cost_of_college
local net_tuition = $AOTC_I_LK_net_tuition
